...
class RegisterInstitutionForm extends PureComponent {
  ...
  render() {
    const { handleSubmit, isSubmitFetching, handleStateChange, cities, states, disableAddress, disableAddressZipCode, handleCepOnChange,
            handleSearch, handleNewAddress, canViewForm, disablePhones, handleNewPhone, isFetchingGet} = this.props;
    return (
      <form onSubmit={handleSubmit} className="uk-form">
        <div className={`uk-form-row`}>
          ...
          <div className="uk-margin-top uk-text-left uk-width-medium-1-1 uk-margin-bottom">
            <a target="_blank" href="https://api.azimute.med.br/Prod/Amgen/LungMapping/docs/Termodeusodainstituicao.pdf" className="uk-button uk-button-large uk-button-primary"> <i className="uk-icon-download" /> Regulamento do Programa</a>
          </div>
        ...
        <div uk-margin-bottom>
          ...
          <a className="uk-button uk-button-large uk-button-danger uk-form-width-medium " href="#" disabled={isSubmitFetching}>Cancelar</a>
