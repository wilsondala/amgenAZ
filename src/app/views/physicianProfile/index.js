...
const mapStateToProps = (state) => {
   // console.log("STATE: ", state);
    ...
    retornoHealthUnit: state.healthUnit.retornoHealthUnit,
  };
...
const mapDispatchToProps = (dispatch) => {
  return bindActionCreators(
    {
      // views
      enterPhysicianProfile: viewsActions.enterPhysicianProfile,
      leavePhysicianProfile: viewsActions.leavePhysicianProfile,
