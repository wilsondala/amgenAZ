      ...
      var cnpj = (document.querySelector('input[name=cnpj]')).value;
        ...
        else
        {
          ...
          if (data.address != undefined)
          {
            ...
            this.getAddressByCep(data.address.zip_Code);
            ...
            this.getCityByState(data.address.state, () => this.props.changeFieldValue("city", data.address.city));
